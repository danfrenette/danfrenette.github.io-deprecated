class HomePage
  ...
  TITLE = CGI.escape("Need to get in touch with a good programmer? Checkout "\
                     "Dan Frenette")
  ...
  LINKS = {
    ...
    linkedin_share_link:  "https://www.linkedin.com/shareArticle?"\
                          "mini=true&url=#{URL}&title=#{TITLE}",
